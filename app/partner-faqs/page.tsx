        ...
        <main className="min-h-screen bg-gray-50">
            ...
            <div className="container mx-auto px-4 py-24 lg:py-32">
                <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-sm border border-gray-100 p-8 lg:p-12">
                    <h1 className="text-3xl lg:text-4xl font-bold mb-4 text-gray-900">Partner Terms & Conditions</h1>
                    ...
                    <div className="prose prose-green max-w-none text-gray-600 space-y-6">
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">3. Eligibility and Partner Registration</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">4. Account Setup and Onboarding</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">5. Partner Obligations and Responsibilities</h3>
                        {/* Same content as Partner Terms because the source file was identical */}
                        <h4 className="font-bold text-gray-800">5.1 Product and Service Quality</h4>
                        ...
                        <h4 className="font-bold text-gray-800">5.2 Order Fulfillment</h4>
                        ...
                        <h4 className="font-bold text-gray-800">5.3 Pricing and Menu Management</h4>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">6. Commission, Fees and Payment Terms</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">7. Order Management and Cancellations</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">8. Restaurant Visibility, Ratings, Reviews and Listing Management</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">9. Prohibited Activities and Partner Conduct</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">10. Intellectual Property</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">11. Suspension, Termination and Account Closure</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">12. Indemnity</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">13. Limitation of Liability</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">14. Dispute Resolution and Governing Law</h3>
                        <p>These Terms are governed by the laws of India. Disputes will be subject to the courts of Bangalore, Karnataka.</p>

                        <h3 className="font-bold text-gray-900 text-xl">15. Grievance Redressal</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">16. Contact</h3>
                        <div className="bg-gray-50 p-4 rounded-xl">
