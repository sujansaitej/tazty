        ...
        <main className="min-h-screen bg-gray-50">
            ...
            <div className="container mx-auto px-4 sm:px-6 py-16 sm:py-20 md:py-24 lg:py-32">
                <div className="max-w-4xl mx-auto bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-10 lg:p-12">
                    <h1 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 text-gray-900">Buyer Terms & Conditions</h1>
                    ...
                    <div className="prose prose-green max-w-none text-gray-600 space-y-4 sm:space-y-5 md:space-y-6 prose-sm sm:prose-base">
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">3. Eligibility</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">4. Account Registration and Authentication</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">5. Services Provided by the Platform</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">6. Product Listings and Seller Responsibilities</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">7. Order Placement, Acceptance and Cancellation</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">8. Delivery Terms</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">9. Pricing, Taxes and Fees</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">10. Payments and Refunds</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">11. Ratings, Reviews and User Content</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">12. User Conduct and Prohibited Activities</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">13. Intellectual Property</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">14. Suspension, Termination and Account Deletion</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">15. Indemnity</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">16. Limitation of Liability</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">17. Force Majeure</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">18. Dispute Resolution and Governing Law</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">19. Grievance Redressal</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">20. Privacy</h3>
                        <p>Your use of the Platform is subject to our Privacy Policy, which explains how we collect and use personal data.</p>

                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">21. Amendments</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-lg sm:text-xl">22. Contact</h3>
                        <div className="bg-gray-50 p-4 rounded-xl">
