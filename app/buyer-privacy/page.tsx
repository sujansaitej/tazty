        ...
        <main className="min-h-screen bg-gray-50">
            ...
            <div className="container mx-auto px-4 py-24 lg:py-32">
                <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-sm border border-gray-100 p-8 lg:p-12">
                    <h1 className="text-3xl lg:text-4xl font-bold mb-4 text-gray-900">Buyer Privacy Policy</h1>
                    ...
                    <div className="prose prose-green max-w-none text-gray-600 space-y-6">
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">2. Information We Collect</h3>
                        <h4 className="font-bold text-gray-800">2.1 Information You Provide</h4>
                        ...
                        <h4 className="font-bold text-gray-800">2.2 Information Collected Automatically</h4>
                        <ul className="list-disc pl-5">
                        ...
                        <h4 className="font-bold text-gray-800">2.3 Third-Party Data</h4>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">3. How We Use Your Information</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">4. Data Storage, Retention & Security</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">5. Disclosure & Sharing</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">6. Your Rights</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">7. Account Deletion & Data Erasure Procedure</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">8. Children’s Privacy</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">9. Cookies & Tracking Technologies</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">10. Links to Other Services</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">11. International Transfers & Affiliates</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">12. Governing Law & Jurisdiction</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">13. Contact & Grievance Officer</h3>
                        ...
                        <h3 className="font-bold text-gray-900 text-xl">14. Permissions & App Store / Play Store Disclosures</h3>
